...
public class Carryingyou_piano extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        mediaPlayer3 = MediaPlayer.create(this,R.raw.carryingyou);
		mediaPlayer3.start();
        
        
        LinearLayout root = (LinearLayout) findViewById(R.id.root);
		// 创建DrawView组件
		final Carryingyou_picture draw = new Carryingyou_picture(this);
		root.addView(draw);
